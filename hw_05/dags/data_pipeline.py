...
S3_DATA_BUCKET = Variable.get("S3_DATA_BUCKET")
S3_AIRFLOW_BUCKET = Variable.get("S3_AIRFLOW_BUCKET")

S3_INPUT_DATA_BUCKET = S3_AIRFLOW_BUCKET + "/airflow/"     # YC S3 bucket for input data
S3_SRC_BUCKET = S3_AIRFLOW_BUCKET[:]                       # YC S3 bucket for pyspark source files
S3_DP_LOGS_BUCKET = S3_AIRFLOW_BUCKET + "/airflow_logs/"   # YC S3 bucket for Data Proc logs
