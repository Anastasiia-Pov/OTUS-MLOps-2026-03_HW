...
5. **Создать скрипт очистки данных** на основе проведенного анализа качества с использованием Apache Spark. Скрипт должен иметь возможность автоматического запуска внешней системой. = [скрипт для батчего запуска](https://github.com/Anastasiia-Pov/OTUS-MLOps-2026-03_HW/blob/main/hw_03/notebooks/batch_procees.ipynb)
